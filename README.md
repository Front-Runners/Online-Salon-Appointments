...
are located in the file [./project/settings.py](../../tree/master/project/settings.py) . Here we have mentioned the installed applications details, database connection details, SMTP server details etc. To run the server, [./manage.py](url) file is used.
